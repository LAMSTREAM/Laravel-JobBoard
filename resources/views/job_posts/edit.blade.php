                ...
                <div class="p-6">
                    ...
                    <form method="POST" action="{{ route('job-posts.update', $jobPost->id) }}">
                        ...
                        <div class="flex justify-end mt-6">
                            <button type="submit"
                                class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-indigo-600 rounded-md font-semibold text-sm text-black uppercase tracking-widest hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                Update Job
                            </button>
                        </div>
                    </form>
